...
optionEl1.addEventListener('click', selectAnswer)
optionEl2.addEventListener('click', newQuestion)
optionEl2.addEventListener('click', selectAnswer)
optionEl3.addEventListener('click', newQuestion)
optionEl3.addEventListener('click', selectAnswer)
optionEl4.addEventListener('click', newQuestion)
optionEl4.addEventListener('click', selectAnswer)